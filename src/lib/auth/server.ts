...
import { CAPACITOR_ORIGINS } from "../capacitor-origins";
...
const trustedOrigins: string[] = explicitBaseURL
  ? [explicitBaseURL, ...LOCAL_DEV_ORIGINS, ...CAPACITOR_ORIGINS]
  : [
      ...
      ...LOCAL_DEV_ORIGINS,
      // iOS/Android Capacitor WebView (bundled app → this hosted API)
      ...CAPACITOR_ORIGINS,
    ];
